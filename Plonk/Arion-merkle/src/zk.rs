...
use arion::sponge::merkle::gadget as arion_merkle_gadget;

/// Builds the gadget for the arion opening and returns the computed
/// root.
    ...
    C: Composer,
{
    ...
    for h in (0..H).rev() {
        ...
        needle = arion_merkle_gadget(composer, &level_witnesses[h]);
    }
